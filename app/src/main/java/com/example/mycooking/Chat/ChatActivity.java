...
import com.example.mycooking.Adapter.ChatAdapter;
import com.example.mycooking.Model.ModelChat;
import com.example.mycooking.Model.Users;
import com.example.mycooking.R;
import com.example.mycooking.notifications.APIServer;
import com.example.mycooking.notifications.Client;
import com.example.mycooking.notifications.Data;
import com.example.mycooking.notifications.Data5;
import com.example.mycooking.notifications.MyResponse;
import com.example.mycooking.notifications.Sender;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)){
                    Toast.makeText(ChatActivity.this,"กรุณาพิมพ์ข้อความ",Toast.LENGTH_SHORT).show();
                }else {
        ...
        apiServer.sendNotification(sender)
                .enqueue(new Callback<MyResponse>() {
                    ...
                    public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                        Toast.makeText(ChatActivity.this, response.headers().toString(), Toast.LENGTH_SHORT).show();
                    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    Data5 data = new Data5(myid,username +" : "+message,hisid,user.getDisplayName());
