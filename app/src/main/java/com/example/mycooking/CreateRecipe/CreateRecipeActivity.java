...
import com.example.mycooking.utils.Files;
import com.example.mycooking.utils.ResultCodes;
...
public class CreateRecipeActivity extends AppCompatActivity implements
    ...
    @Override
    public void navigateToDirectionsFragment(List<String> ingredients) {
